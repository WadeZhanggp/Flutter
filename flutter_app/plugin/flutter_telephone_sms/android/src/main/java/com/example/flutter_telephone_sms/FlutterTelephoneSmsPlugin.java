package com.example.flutter_telephone_sms;
...
/** FlutterTelephoneSmsPlugin */
public class FlutterTelephoneSmsPlugin implements FlutterPlugin, ActivityAware,MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "flutter_telephone_sms");
